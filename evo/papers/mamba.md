...
|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|
| Input: 𝑥 : ( B , L , D ) Output: 𝑦 : ( B , L , D ) 1: 𝑨 : ( D , N )← Parameter ⊲ Represents structured 𝑁 × 𝑁 2: 𝑩 : ( D , N )← Parameter | Input: 𝑥 : ( B , L , D ) 𝑦 : ( B , L , D ) 𝑨 : ( D , N )← Parameter |
|                                                                                                                                          | Output:                                                             |
|                                                                                                                                          | 1:                                                                  |
| matrix                                                                                                                                   | ⊲ Represents structured 𝑁 × 𝑁 matrix                                |
|                                                                                                                                          | 2: 𝑩 : ( B , L , N )← 𝑠 𝐵 ( 𝑥 )                                     |
...
Theorem 1. When 𝑁 = 1 , 𝑨 = -1 , 𝑩 = 1 , 𝑠 Δ = Linear ( 𝑥 ) , and 𝜏 Δ = softplus , then the selective SSM recurrence (Algorithm 2) takes the form
...
|---------|-----------------|---------|-----------|
| S4 -    | No gate No gate | S4 S6   | 18.3 97.0 |
| H3      | H3              | S4      | 57.0      |
| Hyena   | H3              | Hyena   | 30.1      |
| -       | H3              | S6      | 99.7      |
| - -     | Mamba Mamba     | S4      | 56.4 28.4 |
|         |                 | Hyena   |           |
| Mamba   | Mamba           | S6      | 99.8      |
...
- [107] Eugene Vorontsov, Chiheb Trabelsi, Samuel Kadoury, and Chris Pal. 'On Orthogonality and Learning Recurrent Networks with Long Term Dependencies'. In: International Conference on Machine Learning . PMLR. 2017, pp. 35703578.
...
Thus the final discrete recurrence (2a) is as desired.
...
| Model    | Params   | Test Accuracy (%) at Se/q.sc_u.scence Length   | Test Accuracy (%) at Se/q.sc_u.scence Length   | Test Accuracy (%) at Se/q.sc_u.scence Length   | Test Accuracy (%) at Se/q.sc_u.scence Length   | Test Accuracy (%) at Se/q.sc_u.scence Length   | Test Accuracy (%) at Se/q.sc_u.scence Length   | Test Accuracy (%) at Se/q.sc_u.scence Length   | Test Accuracy (%) at Se/q.sc_u.scence Length   | Test Accuracy (%) at Se/q.sc_u.scence Length   | Test Accuracy (%) at Se/q.sc_u.scence Length   | Test Accuracy (%) at Se/q.sc_u.scence Length   | Test Accuracy (%) at Se/q.sc_u.scence Length   | Test Accuracy (%) at Se/q.sc_u.scence Length   | Test Accuracy (%) at Se/q.sc_u.scence Length   | Test Accuracy (%) at Se/q.sc_u.scence Length   |
|----------|----------|------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|
...
| Model    | Params   | Accuracy (%) at Se/q.sc_u.scence Length   | Accuracy (%) at Se/q.sc_u.scence Length   | Accuracy (%) at Se/q.sc_u.scence Length   | Accuracy (%) at Se/q.sc_u.scence Length   | Accuracy (%) at Se/q.sc_u.scence Length   | Accuracy (%) at Se/q.sc_u.scence Length   |
|----------|----------|-------------------------------------------|-------------------------------------------|-------------------------------------------|-------------------------------------------|-------------------------------------------|-------------------------------------------|
...
| Se/q.sc_u.scence length   |   Batch size |   Tokens / batch |
|---------------------------|--------------|------------------|
